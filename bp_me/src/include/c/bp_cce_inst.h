...
typedef enum {
  ...
  ,e_bfz                         = 0x3   // Branch if Flag == 0 // same as BEQ, src_a = flag, src_b = 0

  ,e_bqr                         = 0x0   // Branch if Queue.ready == 1 // same as BEQ src_a = queue.ready, src_b = 1
  ...
  ,e_beqi                        = 0x6   // Branch Equal Immediate
...
typedef enum {
  ...
  ,e_src_mem_data_resp_ready     = 0x12
  ,e_src_pending_ready           = 0x13
  ,e_src_lce_resp_ready          = 0x14
  ,e_src_lce_data_resp_ready     = 0x15
